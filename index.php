	...
	if($_POST){
		...
		if($num>0){
			...
			if($password_bd == $pass_c){
				...
				echo "contraseña erronea existe usuario";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login-TurisLoja</h3>
									</div>
									<div class="imglogo">
								 <img  src="/sistema/img/logo.png"  alt="">
								 </div>
                                    <div class="card-body">
